...
import sample.example.objects.Person;
    ...
    public boolean saveToDB() throws SQLException {
        ...
        try {
            ...
            if (connection != null) {
                ...
                String sql = "INSERT INTO Users(Users_id, username, password, email) VALUES('" + personBean.getUsername()+"','"+personBean.getPassword()+"','"+personBean.getEmail()+"')";
